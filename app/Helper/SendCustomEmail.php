...
class SendCustomEmail
{
    ...
    private static $data=array('name'=>'paperMates');
    public static function textEmail() {
      $isMailSent= Mail::send('mail', self::$data, function($message) {
         $message->to('palwashasheikh229@gmail.com', 'palwasha')->subject('paperMates testing email');
         $message->from('no-reply@solad.com','paperMates Support');
      });
